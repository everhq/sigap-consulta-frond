...
class formularioRegistroTramites extends React.Component{
    constructor(props){
        super(props)
        this.state={
                criterio:[],
    ...
    componentWillMount(){
        console.log("Llegamos a formularioRegistroTramites JS");
        ...
        return(
            <div>
                ...
                <div className="container" >
                        ...
                        <div className="row sombra">
                            <div className="col-md-3"><h6 >Oficio:</h6></div>
                            <div className="col-md-9"><input className="estilo" type="text" id="autorizacion" /></div>
                        </div>
...
export default formularioRegistroTramites
