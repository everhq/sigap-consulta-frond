...
import TramiteMenu from './Componentes/tramites-menu';
...
class Index extends React.Component {
    render() {
        return(
            ...
            <Route path="/tramite/:name" component={Tramite}></Route>
            <Route path="/vista/tramite-m/:name" component={TramiteMenu}></Route>
          </Router>
          )
      }
